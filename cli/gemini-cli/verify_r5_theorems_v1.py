...
# matplotlib をオプション依存性に緩和 (v5.2 - R5_v1)
try:
...
def test_l6_lambert_branch_and_guard():
    ...
    # 可視化プロットの作成 (matplotlib が存在する場合のみ)
    if HAS_MATPLOTLIB:
        try:
...
if __name__ == "__main__":
    print("=" * 50)
    print("Starting R5 Theorems Verification Suite (v5.2 - R5_v1)")
    print("=" * 50)
    ...
    print("=" * 50)
    print("All R5 theorems (L3, L6, L9) verified successfully (v5.2 - R5_v1)!")
    print("=" * 50)
