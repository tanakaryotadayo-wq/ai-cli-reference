...
def test_l2_l7_l9_unified_potential():
    ...
    assert psi_timeout > 4000.0

    print(">> L2/L7/L9 Unified Potential Simulation Test: PASS\n")


# ==========================================
# 6. L3 混雑度ペナルティの v8 スケーリング不整合修正検証 (v8)
# ==========================================
def test_l3_routing_v8_scaling():
    ...
    class V8Router(L3OrthogonalExclusionRouter):
        def route_query_v8(self, q_vec: np.ndarray) -> Tuple[str, float, str]:
            ...
            # v8 修正: 直交回避ロジック通過後の残余誤り率としてのスケーリング調整 (eta = 0.05)
            eta_route = 0.05
    ...
    # テストのセットアップ (N=4, N_max=3, rho=1.33)
    ...
    # 旧ロジック (v7) では DQS/OPF の前に強制エスカレーションされる
    ...
    # 新ロジック (v8) ではペナルティが正常にスケールされ、エスカレーションを回避して DQS/OPF などの解決を試みられる
...
if __name__ == "__main__":
    print("=" * 50)
    print("Starting R5 Theorems Verification Suite (v8 - Scaling Adjustment)")
    print("=" * 50)
    ...
    print("=" * 50)
    print("All theorems verified successfully (v8 - Scaling Adjustment)!")
    print("=" * 50)
