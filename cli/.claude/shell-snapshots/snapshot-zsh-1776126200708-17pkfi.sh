...
if ! (unalias rg 2>/dev/null; command -v rg) >/dev/null 2>&1; then
  alias rg='/Users/ryota/.nvm/versions/node/v24.11.1/lib/node_modules/@anthropic-ai/claude-code/vendor/ripgrep/arm64-darwin/rg'
fi
export PATH=/Users/ryota/.nvm/versions/node/v24.11.1/bin:/usr/bin:/bin:/usr/sbin:/sbin
